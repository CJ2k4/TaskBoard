...
**M0–M3 are done front to back, and the M4 backend is complete.** Next up is the **M4 frontend** — invite-by-email form, member list with roles, and read-only rendering for viewers; then M5 (real-time).
